...
public class IconView implements MouseListener,MouseMotionListener {
	...
	class DropDownMenu extends JPopupMenu{
		...
		public DropDownMenu(){
			...
			add(view);
			add(mode);
			JMenu Queue = new JMenu("Queue Actions");
			JMenuItem AddP = new JMenuItem("Add Playlist to Queue");
			JMenuItem clearQ = new JMenuItem("Clear Queue");
			AddP.addActionListener(head);
			AddP.setActionCommand("addP");
			clearQ.addActionListener(head);
			clearQ.setActionCommand("clearQ");
			Queue.add(AddP);
			Queue.add(clearQ);
			add(Queue);
